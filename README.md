...
<body>
    <header class="container text-center">
        <img src="img/avatar-perfil.png" alt="avatar da Fernanda" class="rounded-circle" width="150" height="150"
            srcset="">
        <p class="lead">Eu sou Naely_</p>
        <h1>Eu estudo no ultimo ano da escola</h1>
        <p>Sou uma estudante de progamação do ultimo ano do ensino médio, eu gosto de paleontologia, filmes de animação do studio ghibli e livros profundos !</p>
